            ...
            >
              ...
              <div className="relative h-[400px] md:h-[600px] overflow-hidden">
                ...
                <div className="absolute top-6 left-6 z-20">
                  <span className="bg-[#b29567] text-white px-4 py-2 text-xs uppercase tracking-widest font-semibold">
                    {listing.badge}
                  </span>
                </div>
              ...
              {/* Right: Content */}
              <div className="p-12 flex flex-col justify-center bg-gradient-to-br from-[#fffefc] to-[#f1ece3] relative z-20">
                <p
